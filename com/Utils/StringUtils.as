	...
	*/
	...
	public class StringUtils {
		...
		*/
		...
		public static function formatTimeExtended(time:Number):String {
			var nHour:String;
			var nMin:String;
			var nSec:String;
			...
			if (hours > 0) {
				return hString + nHour + mString + nMin + sString + nSec;
			} else {
				return mString + nMin + sString + nSec;
			}
		}
	}
}